...
public class UpdateCompainRequest {
	   private String reference;
		...
		public UpdateCompainRequest() {
			super();
		}
		public UpdateCompainRequest(String reference, String nom, String address, String email, String telephone,
